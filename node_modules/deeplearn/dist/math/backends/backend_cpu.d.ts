...
export declare class MathBackendCPU implements MathBackend {
    private data;
    dispose(): void;
    write<T extends DataType>(id: number, values: DataTypeMap[T], dtype: T, shape: number[]): void;
    ...
    topKValues<D extends DataType, T extends NDArray<D>>(x: T, k: number): Array1D<D>;
    ...
    maxPoolPositions(x: Array4D, convInfo: Conv2DInfo): Array4D<"float32" | "int32" | "bool">;
    ...
    private broadcastedBinaryOp<D>(a, b, dtype, op);
}
